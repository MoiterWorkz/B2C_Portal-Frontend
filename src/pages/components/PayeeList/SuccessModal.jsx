...
import {  CheckCircle2,  CheckCircleIcon,  LucideCircleCheck, X } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      <div className=" bg-card green-border  text-white rounded-xl w-[380px] p-6 relative shadow-xl">
        <div className="mb-8">
          <span className="text-green-500 flex gap-2 small-text"><CheckCircleIcon size={18}/> Transfer Successful!</span>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="my-green-box w-full rounded-lg p-4 text-left text-sm ">
            ...
            <p className="mb-2 flex justify-between">
              <strong className="gray-text">To:</strong> <span className="text-white font-semibold small-text">{payee?.name}</span>
            </p>
            <p className="mb-2 flex justify-between">
              <strong className="gray-text">Transaction ID:</strong> <span className="text-white small-text">{transactionId}</span>
            </p>
            <p className="flex justify-between">
              <strong className="gray-text">Time:</strong> <span className="text-white small-text">{date}</span>
            </p>
          </div>
